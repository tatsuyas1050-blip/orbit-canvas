...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- PWA Push Notification Logic (ボタン駆動式) ---
    ...
    async function subscribeUser(registration) {
        if (!PUBLIC_VAPID_KEY || PUBLIC_VAPID_KEY === "YOUR_PUBLIC_VAPID_KEY") {
    ...
    async function updateSubscriptionOnServer(subscription) {
        if (!SAVE_SUBSCRIPTION_URL || SAVE_SUBSCRIPTION_URL.includes("YOUR_LAMBDA_URL")) {
